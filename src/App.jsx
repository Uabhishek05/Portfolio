  ...
  return (
    ...
    >
      ...
      <footer className="border-t border-white/10 bg-slate-950/70 py-8 text-center text-sm text-slate-400">
        <div className="mx-auto inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-4 py-2 text-base font-medium text-slate-200">
          <span aria-hidden="true">👀</span>
          <span>
            Total Visits: <span className="font-bold text-sky-300">{visitCount}</span>
          </span>
        </div>
        <p className="mt-4 text-base text-slate-300">Thanks for scrolling! 👋 - Built by {personal.name}</p>
        <p className="mt-1 text-slate-400">© {new Date().getFullYear()}. All rights reserved.</p>
      </footer>
